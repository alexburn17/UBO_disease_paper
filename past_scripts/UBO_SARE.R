...
ds <- read.csv("data/SARE_field_database2022.csv", header = TRUE, stringsAsFactors = FALSE)
virus <- read.csv("data/DWV_SARE2021.csv", header = TRUE, stringsAsFactors = FALSE)
virus2022 <- read.csv("data/DWV_SARE2022.csv", header = TRUE, stringsAsFactors = FALSE)
